...
public class BezierSpline : MonoBehaviour
{
    ...
    public Vector3 GetPoint(float t)
    {
        ...
        return transform.TransformPoint(Bezier.GetPoint(points[i + 0], points[i + 1], points[i + 2], points[i + 3], t));
    }
    ...
    public Vector3 GetNormal(float t)
    {
        ...
        return Bezier.GetSecondDerivative(points[i + 0], points[i + 1], points[i + 2], points[i + 3], t);

    }

    public Vector3 GetUnitNormal(float t)
    {
        return GetNormal(t).normalized;
    }

    public float GetCurvature(float t)
    {
        return GetNormal(t).magnitude;
    }
